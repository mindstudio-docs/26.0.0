...
分析迁移工具更多介绍请参见《[分析迁移工具用户指南](https://gitcode.com/Ascend/mstt/blob/26.0.0/msfmktransplt/README.md)》。
...
具体请参见《[msProbe工具安装指南](https://gitcode.com/Ascend/msprobe/blob/26.0.0/docs/zh/msprobe_install_guide.md)》。
...
4. 查看结果。
   ...
   **图1** 结果文件内容
   ...
   输出结果详细介绍请参见“[输出结果文件说明](https://gitcode.com/Ascend/msprobe/blob/26.0.0/docs/zh/monitor_v2_instruct.md#%E8%BE%93%E5%87%BA%E7%BB%93%E6%9E%9C%E6%96%87%E4%BB%B6%E8%AF%B4%E6%98%8E)”。
...
4. 预检结果分析。
   ...
   - api_precision_compare_details_{timestamp}.csv文件会标明每个API是否通过测试，示例如下。
     ...
     **图3** api_precision_compare_details_2
     ...
     更多比对结果字段含义请参见“[预检结果比对](https://gitcode.com/Ascend/msprobe/blob/26.0.0/docs/zh/accuracy_checker/pytorch_accuracy_checker_instruct.md#%E9%A2%84%E6%A3%80%E7%BB%93%E6%9E%9C%E6%AF%94%E5%AF%B9)”。
...
3. 比对结果文件分析。
   ...
   更多比对结果分析请参见“[精度比对结果分析](https://gitcode.com/Ascend/msprobe/blob/26.0.0/docs/zh/accuracy_compare/pytorch_accuracy_compare_instruct.md#%E7%B2%BE%E5%BA%A6%E6%AF%94%E5%AF%B9%E7%BB%93%E6%9E%9C%E5%88%86%E6%9E%90)”。
...
1. 在昇腾NPU环境下的训练脚本（pytorch_main.py文件）中添加Ascend PyTorch Profiler接口工具，如下所示。
   ...
   > [!NOTE]
   >
   > - 以上仅提供简单示例，若需要配置更完整的采集参数以及对应接口详细介绍请参见《[Ascend PyTorch调优工具](https://gitcode.com/Ascend/pytorch/blob/v2.7.1-26.0.0/docs/zh/ascend_pytorch_profiler/ascend_pytorch_profiler_user_guide.md)》。
...
3. 安装msprof-analyze，命令如下：
   ...
   msprof-analyze工具详细介绍请参见《[msprof-analyze](https://gitcode.com/Ascend/msprof-analyze/blob/26.0.0/docs/zh/README.md)》。
...
2. 执行性能分析操作。
   ...
   更多介绍请参见《[msprof-analyze](https://gitcode.com/Ascend/msprof-analyze/blob/26.0.0/docs/zh/README.md)》。
...
详细结果介绍请参见《[advisor](https://gitcode.com/Ascend/msprof-analyze/blob/26.0.0/docs/zh/advisor_instruct.md)》中的“[输出结果文件说明](https://gitcode.com/Ascend/msprof-analyze/blob/26.0.0/docs/zh/advisor_instruct.md#%E8%BE%93%E5%87%BA%E7%BB%93%E6%9E%9C%E6%96%87%E4%BB%B6%E8%AF%B4%E6%98%8E)”。
...
性能比对工具将总体性能拆解为训练耗时和内存占用，其中训练耗时可拆分为算子（包括nn.Module）、通信、调度三个维度，并打印输出总体指标，帮助用户定位劣化的方向。与此同时，工具还会在“performance_comparison_result_{timestamp}.xlsx”文件中展示每个算子在执行耗时、通信耗时、内存占用的优劣，可通过DIFF列大于0筛选出劣化算子。此处不提供示例，详细结果介绍请参见《[性能比对工具](https://gitcode.com/Ascend/msprof-analyze/blob/26.0.0/docs/zh/compare_tool_instruct.md)》中的“[输出结果文件说明](https://gitcode.com/Ascend/msprof-analyze/blob/26.0.0/docs/zh/compare_tool_instruct.md#%E8%BE%93%E5%87%BA%E7%BB%93%E6%9E%9C%E6%96%87%E4%BB%B6%E8%AF%B4%E6%98%8E)”。
...
1. 安装MindStudio Insight。
   ...
   参见《[MindStudio Insight工具用户指南](https://gitcode.com/Ascend/msinsight/blob/26.0.0/docs/zh/user_guide/overview.md)》下载并安装MindStudio Insight。
...
4. 分析性能数据。
   ...
   MindStudio Insight工具将性能数据可视化后可以更直观地分析性能瓶颈，详细分析方法请参见《[MindStudio Insight工具用户指南](https://gitcode.com/Ascend/msinsight/blob/26.0.0/docs/zh/user_guide/overview.md)》。
