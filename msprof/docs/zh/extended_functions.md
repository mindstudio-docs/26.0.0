...
```bash
python3 get_msprof_info.py -dir <dir> [-h]
```
...
>[!NOTE] 
>该功能为msprof工具解析后输出调优建议的功能，已不再演进，分析性能数据并输出调优建议更多的功能请参见《[msprof-analyze](https://gitcode.com/Ascend/msprof-analyze/blob/26.0.0/docs/zh/README.md)》。
