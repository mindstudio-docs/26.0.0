...
| 开源软件 | -            | msprechecker/pyproject.toml                   | <https://gitcode.com/Ascend/msit/tree/26.0.0/msprechecker> | msprechecker工具的仓库地址 |
| 开源软件 | -            | msprechecker/pyproject.toml                   | <https://gitcode.com/Ascend/msit/issues>                   | msit仓的issue地址          |
| 开源软件 | -            | msserviceprofiler/pyproject.toml                   | <https://gitcode.com/Ascend/msit/blob/26.0.0/msserviceprofiler/Changelog.md>                   | msserviceprofiler版本变更说明          |
| 开源软件 | -            | msmodelslim/config/config.ini                 | <https://gitcode.com/Ascend/msit>                          | msit仓的地址               |
| 开源软件 | -            | msmodelslim/config/config.ini                 | <https://gitcode.com/Ascend/msit/blob/26.0.0/msmodelslim/docs/FAQ.md>                          | msmodelslim仓FAQ文档的地址               |
...
| 开源软件 | - | msit/components/debug/compare/setup.py | <https://gitcode.com/Ascend/msit/tree/26.0.0/msit/components/debug/compare> | 用于compare组件打包成python包的主页说明 |
...
| 开源软件 | - | msit/components/config/config.ini | <https://gitcode.com/Ascend/msit/tree/26.0.0/msit/components/debug/compare> | msit debug compare工具仓库地址 |
| 开源软件 | - | msit/components/config/config.ini | <https://gitcode.com/Ascend/msit/tree/26.0.0/msit/components/debug/opcheck> | msit debug opcheck工具仓库地址 |
